...
" This needs to be updated to ensure everything matches with Moonlight (or any other theme we're using)
" telescope_theme() runs off of a helper function to adjust coloration based on theme utilized.
